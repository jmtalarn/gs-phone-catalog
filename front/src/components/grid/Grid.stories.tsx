...
DefaultGrid.args = {
	items: [
		...
		},
		{
			...
			color: 'grey',
			price: 209,
			imageFileName: 'http://localhost:3001/images/Galaxy_S7.png',
		...
		},
		{
			...
			color: 'blue',
			price: 399,
			imageFileName: 'http://localhost:3001/images/Honor_10.png',
		...
		},
		{
			...
			color: 'white',
			price: 249,
			imageFileName: 'http://localhost:3001/images/P10_Lite.jpg',
		...
		},
		{
			...
			color: 'black',
			price: 275,
			imageFileName: 'http://localhost:3001/images/Nokia_7.1.jpg',
			screen: '5,84 inch Full-HD',
			processor: 'Octa-core',
			ram: 4,
		},
		{
			...
			color: 'black',
			price: 359,
			imageFileName: 'http://localhost:3001/images/ZenPhone_5.jpg',
		...
		},
		{
			...
			color: 'black',
			price: 179,
			imageFileName: 'http://localhost:3001/images/Xiaomi_MI_A2.jpeg',
		...
		},
		{
			...
			color: 'black',
			price: 199,
			imageFileName: 'http://localhost:3001/images/Moto_G6.png',
